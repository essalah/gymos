package com.lhach.gymos.views.memberlist;

import java.util.Optional;

import com.lhach.gymos.data.entity.SamplePerson;
import com.lhach.gymos.data.service.SamplePersonService;
...
@RolesAllowed("admin")
@Uses(Icon.class)
public class MemberListView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "card-list/%d/edit";
    ...
    public MemberListView(@Autowired SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("member-list-view", "flex", "flex-col", "h-full");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(MemberListView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(MemberListView.class);
            }
        }
    }
