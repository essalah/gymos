package com.lhach.gymos.data.generator;

import com.vaadin.flow.spring.annotation.SpringComponent;

import com.lhach.gymos.data.service.SamplePersonRepository;
import com.lhach.gymos.data.entity.SamplePerson;
import com.lhach.gymos.data.service.UserRepository;
    ...
    public CommandLineRunner loadData(PasswordEncoder passwordEncoder, SamplePersonRepository samplePersonRepository,
        ...
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2021, 11, 17, 0, 0, 0));
